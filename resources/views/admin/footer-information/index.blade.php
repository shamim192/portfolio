      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.footer-information.update',1)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                 @method('PUT')
                 ...
                 <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                     <textarea name="info" class="form-control" style="height: 100px" id="" >{{$footerInfo->info}}</textarea>
                    </div>
                  </div>  
